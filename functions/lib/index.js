...
exports.checkFCMTokens = exports.sendTestNotification = exports.updateFCMToken = exports.sendOrderNotification = void 0;
...
exports.checkFCMTokens = (0, https_1.onRequest)(async (req, res) => {
    try {
        const tokensSnapshot = await admin.firestore()
            .collection('fcmTokens')
            .get();
